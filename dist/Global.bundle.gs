...
/******/ 	return __webpack_require__(__webpack_require__.s = "./server/Global.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util */ "./server/util.js");



function listFileNames(folderId) {
  var folder = DriveApp.getFolderById(folderId);
  var files = Object(_util__WEBPACK_IMPORTED_MODULE_1__["iterToArray"])(folder.getFiles());
...
function doGet() {
  ...
  var files = listFileNames('16SQCIy97DRDsRAhpKBilbMh8hlazQAhZ');
  var html = "hi!\n<pre>".concat(files.join('\n'), "</pre>\n");
...
/*!************************!*\
  !*** ./server/util.js ***!
  \************************/
/*! exports provided: iterToArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "iterToArray", function() { return iterToArray; });
/**
